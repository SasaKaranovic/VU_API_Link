...
if __name__ == '__main__':
    ...
    apply_version_tag(footer_path, '{{API_LINK_VERSION}}', version_tag)
    ...
    apply_version_tag(installer_path, '{{API_LINK_VERSION_MAJOR}}', version_major)
    apply_version_tag(installer_path, '{{API_LINK_VERSION_MINOR}}', version_minor)
    apply_version_tag(installer_path, '{{API_LINK_VERSION_BUILD}}', version_build)
